...
@interface CMMotionActivity (SWIFT_EXTENSION(NEContextSDK))
@end



/// This class manages all other contexts - NESituation, NETimeOfDay, NEDayCategory, NEWeather, NELoudness, NELightness, NEIndoorOutdoor, NEActivity, NEMood, NEPlace.
///
/// We recommend all developers to use the NEContextManager (through the singleton instance - 'sharedInstance') to subscribe for the necessary events.
SWIFT_CLASS("_TtC12NEContextSDK16NEContextManager")
@interface NEContextManager : NSObject
@end


@interface NSDate (SWIFT_EXTENSION(NEContextSDK))
@end


@interface NSNotificationCenter (SWIFT_EXTENSION(NEContextSDK))
@end


SWIFT_CLASS("_TtC12NEContextSDK12Reachability")
